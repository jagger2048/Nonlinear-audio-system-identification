...
}spl_frame_st,*spl_frame_p;

spl_frame_p spl_frame_new(size_t sample_rate, size_t frame_size) {
...
void static inline spl_frame_load_s16(spl_frame_p pFrame, size_t channel,void* dest, const void* src, size_t count) {
...
void static inline spl_frame_load_f32(spl_frame_p pFrame, size_t channel, void* dest, const void* src, size_t count) {
...
int spl_frame_free(spl_frame_p pFrame) {
	if (pFrame !=NULL)
	{
		for (size_t channel = 0; channel < 2; channel++)
		{
